...
def main(args):
    ...
    vae = AutoencoderKL.from_pretrained(
        args.pretrained_model_name_or_path, subfolder="vae", revision=args.revision, variant=args.variant,ignore_mismatched_sizes=True,  # 允许部分权重加载
        low_cpu_mem_usage=False,      # 禁用内存优化模式
        device_map=None 
    )
