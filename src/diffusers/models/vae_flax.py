...
class FlaxEncoder(nn.Module):
    ...
    def setup(self):
        ...
        #hyper
        self.hyper_compute = HyperComputeModule(block_out_channels[0], block_out_channels[0], threshold=9, hidden_size=384)
        # downsampling
        down_blocks = []
    ...
    def __call__(self, sample, deterministic: bool = True):
        ...
        #hyper
        sample = self.hyper_compute(sample)
        # downsampling
...
class FlaxDecoder(nn.Module):
    ...
    def setup(self):
        ...
        #hyper
        self.hyper_compute = HyperComputeModule(block_out_channels[-1], block_out_channels[-1], threshold=9, hidden_size=384)
        # middle
        self.mid_block = FlaxUNetMidBlock2D(
            in_channels=block_out_channels[-1],
            resnet_groups=self.norm_num_groups,
